...
export default function Home() {
  const htmlContent = `
    ...
    <!-- Floating 3D Rotating Lottie bottle -->
    <div class="bottle">
      <div class="bottle-wrapper" data-w-id="edfd468a-b958-925d-61b5-11d0c19fccfd" style="opacity:0">
        <div class="bottle-lottie" data-animation-type="lottie" data-autoplay="0" data-default-duration="1.5416666666666667" data-direction="1" data-duration="1.5416666666666667" data-is-ix2-target="1" data-loop="0" data-renderer="svg" data-src="${brand.assets.bottleLottie}" data-w-id="cf753e38-c0d7-7257-8024-07bf7e77f4b0"></div>
      </div>
    </div>
  `;
