...
const BRAND_STYLES = `
  ...
  .site-preloader {
    ...
    color: #fff;
    background:
      linear-gradient(180deg, rgba(12, 4, 1, 0.96), rgba(4, 1, 0, 0.98)),
      radial-gradient(circle at 50% 45%, rgba(199, 134, 52, 0.34), rgba(6, 2, 0, 0.98) 62%);
  }
  .site-preloader::before {
    ...
    color: transparent;
    -webkit-text-stroke: 1px rgba(199, 134, 52, 0.18);
  ...
  .site-preloader::after {
    ...
    bottom: 0;
    height: 18vh;
    background: linear-gradient(180deg, rgba(199, 134, 52, 0), rgba(199, 134, 52, 0.16));
    pointer-events: none;
  }
  .site-preloader__mark,
  .site-preloader__body {
    position: relative;
    z-index: 1;
  }
  .site-preloader__mark {
    ...
    border-radius: 50%;
    box-shadow: 0 0 42px rgba(199, 134, 52, 0.28), inset 0 0 28px rgba(199, 134, 52, 0.12);
  ...
  .site-preloader__bar {
    height: 100%;
    background: linear-gradient(90deg, ${brand.primaryColor}, #fff0b8);
    box-shadow: 0 0 22px rgba(199, 134, 52, 0.75);
